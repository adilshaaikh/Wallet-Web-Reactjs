...
import {getwallets,updateWallet} from '../../../actions/projectActions'
...
class UpdateWallet extends Component {
    ...
    componentDidMount(){
        this.props.getwallets(this.props.match.params.id)
    }
...
export default connect(mapStateToProps,{getwallets,updateWallet})(UpdateWallet)